...
### Swallowing
```{r}
out <- here::here("Manuscript", manuscript_version, "result_data", "01_Swallowing")
...
articulation_data_original <- rio::import(
  ...
  dplyr::filter(!stringr::str_detect(SpeakerID, "_rel")) |>
...
base::saveRDS(object = articulation,
              file = here::here("Manuscript", manuscript_version, "result_data","02_Articulation","analysisData.RDS"))
```
...
base::saveRDS(object = fluency,
              file = here::here("Manuscript", manuscript_version, "result_data","03_Fluency","analysisData.RDS"))
```
...
base::saveRDS(object = voice,
              file = here::here("Manuscript", manuscript_version, "result_data","04_Voice_Resonance","analysisData.RDS"))
```
...
hearing_analyze_data <- function(data) {
  ...
  list(
    ...
    effect_size = exp(model_fit$coefficients$fixed[3]),
...
base::saveRDS(object = hearing,
              file = here::here("Manuscript", manuscript_version, "result_data","05_Hearing","analysisData.RDS"))
```
...
base::saveRDS(object = aac,
              file = here::here("Manuscript", manuscript_version, "result_data","06_AAC","analysisData.RDS"))
```
...
base::saveRDS(object = language,
              file = here::here("Manuscript", manuscript_version, "result_data","07_Language", "Kearney", "analysisData.RDS"))
```
...
```{r robinaugh language, echo = FALSE}
library(kableExtra)
library(tidybayes)
library(tidyr)

out <- here::here("Manuscript", manuscript_version, "result_data","07_Language")
dir.create(out, showWarnings = F)

out <- here::here(out, "Robinaugh")
dir.create(out, showWarnings = F)
...
synthetic_model <- brm(response ~ 0 + Intercept + session + phase + slope_change + 
           ...
           seed = 42,
           refresh = 0, #for the markdown document 
           file = here::here("Data", "07_Language", "Robinaugh", "synthetic_model.rds"),
             #here::here("Manuscript", manuscript_version, "result_data", "07_Language", "Robinaugh", "synthetic_model"),
           file_refit = "on_change"
)

#synthetic_model <- readRDS(here::here("Data","07_Language", "Robinaugh", "analysisDataBayesian.RDS"))
...
#robinaugh <- list(
#  synthetic_es_summarized = synthetic_es_summarized,
#  synthetic_es = synthetic_es,
#  synthetic_pred_d = synthetic_pred_d,
...
out <- here::here("Manuscript", manuscript_version, "result_data", "08_Cognition")
dir.create(out, showWarnings = F)

if (!file.exists(here::here(out,"analysisData.RDS"))) {
...
cognition_analyze_data <- function(data) {
  ...
  list(
    ...
    effect_size = exp(model_fit$coefficients[4,1]),
...
cognition <- list(
  ...
  combined_data = cognition_combined_data,
...
base::saveRDS(object = cognition,
              file = here::here(out,"analysisData.RDS"))

} else {
  cognition <- base::readRDS(file = here::here(out,"analysisData.RDS"))
}


# Data viz
cognition_p1 <- 
  cognition$combined_data |> 
...
base::saveRDS(object = social,
              file = here::here("Manuscript", manuscript_version, "result_data","09_Social_Communication","analysisData.RDS"))
```
...
# save figure
ggsave(
  filename = here::here("Manuscript", manuscript_version, "tables-figures", "figure_1.png"),
    combined_plots2,
    height = 15,
    width = 13,
    dpi = 300,
...
# Load in the data
swallowing <- base::readRDS(file = here::here("Manuscript", manuscript_version, "result_data","01_Swallowing","analysisData.RDS"))
articulation <- base::readRDS(file = here::here("Manuscript", manuscript_version, "result_data","02_Articulation","analysisData.RDS"))
fluency <- base::readRDS(file = here::here("Manuscript", manuscript_version, "result_data","03_Fluency","analysisData.RDS"))
voice <- base::readRDS(file = here::here("Manuscript", manuscript_version, "result_data","04_Voice_Resonance","analysisData.RDS"))
hearing <- base::readRDS(file = here::here("Manuscript", manuscript_version, "result_data","05_Hearing","analysisData.RDS"))
aac <- base::readRDS(file = here::here("Manuscript", manuscript_version, "result_data","06_AAC","analysisData.RDS"))
language <- base::readRDS(file = here::here("Manuscript", manuscript_version, "result_data","07_Language", "Kearney", "analysisData.RDS"))
cognition <- base::readRDS(file = here::here("Manuscript", manuscript_version, "result_data","08_Cognition","analysisData.RDS"))
social <-base::readRDS(file = here::here("Manuscript", manuscript_version, "result_data","09_Social_Communication","analysisData.RDS"))
...
doc <- read_docx(here("manuscript", "templates-data", "template.docx"))
doc <- body_add_flextable(doc, value = t2)
fileout <- here("manuscript", manuscript_version, "tables-figures", "supplemental_table_1.docx") # uncomment to write in your working directory
print(doc, target = fileout)
```
